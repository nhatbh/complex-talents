...
/**
 * An active talent that supports branching paths
 */
public abstract class BranchingActiveTalent extends ActiveTalent implements BranchingTalentBase {

    public BranchingActiveTalent(ResourceLocation id, Component name, Component description,
